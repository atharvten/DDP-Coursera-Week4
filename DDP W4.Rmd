...
The application is running on (https://atharvten.shinyapps.io/Reproducible_Pitch/)

ui.R, and Server.R Code in my github repository (https://github.com/atharvten/Reproducible_Pitch)
